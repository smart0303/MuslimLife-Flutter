    ...
    return Scaffold(
      ...
      body: Stack(
        children: [
          ...
          CustomAppbarWidget(
            screenTitle: 'islamic_calender2'.tr,
          ),
          Theme(
            data: theme.copyWith(
              dialogBackgroundColor: AppColors.colorError,
            ),
            child: dialog,
          ),
        ],
...
class _DatePickerHeader extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    final TextStyle? dayStyle = headerTextTheme.headlineMedium
        ?.copyWith(color: AppColors.colorWhiteHighEmp, height: 1.4);
    final TextStyle? yearStyle = headerTextTheme.titleMedium
        ?.copyWith(color: AppColors.colorWhite70, height: 1.4);
